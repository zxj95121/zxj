...
class UserController extends BasicController
{
    ...
    { 
        ...
        return view('resume/user/index', ['userinfo' => $this->userinfo]); 
    }
    ...
    public function _list(Request $request)
    {
        ...
        $result = ResUserModel::getData($page, $pagesize, ['id', 'name', 'vip_id', 'identity', 'status', 'created_at']);
    ...
    public function edit( Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return view('resume/user/edit', $assign);
        }
