...
<link rel="stylesheet" href="/plugin/mediaPlay/zy.media.min.css">
	...
	<div class="playvideo">
		<div class="zy_media">
	    	<video poster="/images/father/videoShow.png" data-config='{"mediaTitle": "没有title"}'>
		...
		<!-- <img src="{{$obj['img_url']}}"> -->
		<div id="content" style="top: 233px;position: relative;display: none;">
